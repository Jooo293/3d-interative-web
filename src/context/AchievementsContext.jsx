...
export const ACHIEVEMENTS = {
    corridor_enter: { id: 'corridor_enter', label: "探索入口", title: "初次来访" },
    corridor_explore: { id: 'corridor_explore', label: "走廊探索", title: "漫游者" },
    about_fly: { id: 'about_fly', label: "成长经历", title: "云端旅人" },
    studio_interact: { id: 'studio_interact', label: "工作室探索", title: "灵感观察者" },
    gallery_inspect: { id: 'gallery_inspect', label: "项目详情", title: "作品鉴赏者" },
    contact_choose: { id: 'contact_choose', label: "联系方式", title: "新的连接" }
};
