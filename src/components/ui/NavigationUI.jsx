...
const ROOMS = [
    { id: 'about', label: '关于我', x: 43, y: 38 },
    { id: 'gallery', label: '项目展示', x: 43, y: 72 },
    { id: 'contact', label: '联系我', x: 57, y: 25 },
    { id: 'studio', label: '技能工作室', x: 57, y: 55 },
];
                ...
                <div className={`map-panel ${isMenuOpen ? 'open' : ''}`} inert={!isMenuOpen ? true : undefined} ref={mapPanelRef} onKeyDown={handleMapKeyDown} role="dialog" aria-label="地图">
                    ...
                    <div className="map-content-clipped">
                        ...
                        <div className="map-container">
                            ...
                            <div className="map-room-label gallery"><br />项目展示</div>
                            <div className="map-room-label contact">联系我</div>
                            <div className="map-room-label studio"><br />技能工作室</div>
                            ...
                            >
                                <img src="/images/pin.webp" alt="当前位置" className="pin-image" />
                            </div>
                        </div>
                    </div>
                </div>
